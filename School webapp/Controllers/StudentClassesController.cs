...
namespace School_webapp.Controllers
{
    public class StudentClassesController : Controller
    {
        ...
        public StudentClassesController(School_webappContext context)
        {
            _context = context;
        }
        ...
        {
              return _context.StudentClass != null ? 
                          View(await _context.StudentClass.ToListAsync()) :
                          Problem("Entity set 'School_webappContext.StudentClass'  is null.");
        }
        ...
        {
          return (_context.StudentClass?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
