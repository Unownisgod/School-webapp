...
namespace School_webapp.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,tittle,description,deadline,calification,isSubmitted,isRated,canBeSubmittedLate,isLate,classId")] Activity activity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,tittle,description,deadline,calification,isSubmitted,isRated,canBeSubmittedLate,isLate,classId")] Activity activity)
        {
            if (id != activity.Id)
            {
                return NotFound();
